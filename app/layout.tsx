...
export const metadata: Metadata = {
  ...
  title: {
    default: "WinTuner — Ehsan Ghaffar's Digital Laboratory",
    template: "%s | WinTuner",
  },
  description:
  ...
  authors: [{ name: "Ehsan Ghaffar", url: "https://github.com/WinTuner" }],
  ...
  openGraph: {
    ...
    locale: "en_US",
    url: "/",
    title: "WinTuner — Ehsan Ghaffar's Digital Laboratory",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "WinTuner — Ehsan Ghaffar's Digital Laboratory",
      },
    ],
  },
  twitter: {
