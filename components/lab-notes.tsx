...
const notes = {
  ...
  th: [
    {
      id: 1,
      title: "สร้างลินุกซ์ดิสโทรจากศูนย์",
      excerpt: "บทเรียนจากการคอมไพล์เคอร์เนล ตั้งค่า BusyBox และทำ ISO ที่บูตได้ด้วย Syslinux",
      date: "พ.ย. 2025",
      category: "systems",
      color: "from-blue-500/20 to-cyan-500/20",
    },
    {
      id: 2,
      title: "MCP protocol ในแอป LLM",
      excerpt: "ทดลองใช้ Model Context Protocol เพื่อเชื่อมโมเดล AI กับเวกเตอร์ดาต้าเบสในแอป RAG",
      date: "เม.ย. 2025",
      category: "ai",
      color: "from-purple-500/20 to-pink-500/20",
    },
    {
      id: 3,
      title: "Next.js 16 + Tailwind v4",
      excerpt: "สำรวจฟีเจอร์ใหม่ของ Next.js 16 และการย้ายไปใช้ระบบคอนฟิกใหม่ของ Tailwind CSS v4",
      date: "ธ.ค. 2024",
      category: "frontend",
      color: "from-primary/20 to-emerald-500/20",
    },
    {
      id: 4,
      title: "Self-hosting LLMs ด้วย FastAPI",
      excerpt: "รัน Llama2 บนเครื่องและสร้าง API แชตบอตส่วนตัวสำหรับงานภาษาธรรมชาติ",
      date: "ต.ค. 2023",
      category: "ai",
      color: "from-orange-500/20 to-amber-500/20",
    },
...
export function LabNotes() {
  ...
  const t = {
    en: {
      kicker: "Field Notes",
      title: "Lab Notes",
      desc: "Brief observations, technical findings, and thoughts from the workbench.",
      readMore: "read more",
    },
    th: {
      kicker: "บันทึกภาคสนาม",
      title: "Lab Notes",
      desc: "บันทึกสั้นๆ เกี่ยวกับการทดลอง ข้อค้นพบทางเทคนิค และไอเดียจากเวิร์กเบนช์",
      readMore: "อ่านต่อ",
    },
  }[language]
