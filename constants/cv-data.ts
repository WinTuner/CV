...
export const selfDevelopment = {
	en: {
		certifications: [
			...
			{ name: "TOEIC Listening & Reading 785", institution: "ETS" },
			{ name: "IELTS Academic 7.0", institution: "British Council / IDP" },
			{ name: "TOEFL iBT 95", institution: "ETS" },
			{ name: "Cambridge B2 First (FCE)", institution: "Cambridge English" },
			{ name: "CEFR English C1", institution: "Common European Framework" },
			{ name: "JLPT N4 Passed", institution: "Japan Foundation / JEES" },
			{ name: "JLPT N3 (In Progress)", institution: "Japan Foundation / JEES" },
			{ name: "HSK Level 4", institution: "Chinese Testing International (Hanban)" },
			{ name: "HSKK Intermediate", institution: "Chinese Testing International" },
			{ name: "TOPIK I Level 2", institution: "NIIED / King Sejong Institute" },
			{ name: "DELF B1", institution: "France Éducation International" },
			{ name: "Goethe-Zertifikat B1", institution: "Goethe-Institut" },
			{ name: "DELE B1", institution: "Instituto Cervantes" },
			{ name: "CU-TEP 75", institution: "Chulalongkorn University" },
		],
		workshops: [
			{
	...
	th: {
		certifications: [
			...
			{ name: "TOEFL iBT 95", institution: "ETS" },
			{ name: "Cambridge B2 First (FCE)", institution: "Cambridge English" },
			{ name: "CEFR ภาษาอังกฤษ C1", institution: "Common European Framework" },
			{ name: "JLPT N4 ผ่าน", institution: "Japan Foundation / JEES" },
			{ name: "JLPT N3 (กำลังเรียน)", institution: "Japan Foundation / JEES" },
			{ name: "HSK ระดับ 4", institution: "Chinese Testing International (Hanban)" },
			{ name: "HSKK ระดับกลาง", institution: "Chinese Testing International" },
			{ name: "TOPIK I ระดับ 2", institution: "NIIED / King Sejong Institute" },
			{ name: "DELF B1", institution: "France Éducation International" },
			{ name: "Goethe-Zertifikat B1", institution: "Goethe-Institut" },
			{ name: "DELE B1", institution: "Instituto Cervantes" },
			{ name: "CU-TEP 75", institution: "จุฬาลงกรณ์มหาวิทยาลัย" },
		],
		workshops: [
	...
	ja: {
		certifications: [
			...
			{ name: "TOEIC L&R 785", institution: "ETS" },
			{ name: "IELTS Academic 7.0", institution: "British Council / IDP" },
			{ name: "TOEFL iBT 95", institution: "ETS" },
			{ name: "ケンブリッジ英検 B2 First (FCE)", institution: "Cambridge English" },
			{ name: "CEFR 英語 C1", institution: "Common European Framework" },
			{ name: "JLPT N4 合格", institution: "日本国際教育支援協会 / 国際交流基金" },
			{ name: "JLPT N3（挑戦中）", institution: "日本国際教育支援協会 / 国際交流基金" },
			{ name: "HSK 4級", institution: "中国国家漢語水平考試 (Hanban)" },
			{ name: "HSKK 中級", institution: "中国国家漢語水平考試" },
			{ name: "TOPIK I 2級", institution: "NIIED / 世宗学堂" },
			{ name: "DELF B1", institution: "France Éducation International" },
			{ name: "ゲーテ・ドイツ語検定 B1", institution: "Goethe-Institut" },
			{ name: "DELE B1", institution: "Instituto Cervantes" },
			{ name: "CU-TEP 75", institution: "チュラロンコン大学" },
		],
		workshops: [
			{
	...
	zh: {
		certifications: [
			...
			{ name: "托业听读 785", institution: "ETS" },
			{ name: "雅思 Academic 7.0", institution: "British Council / IDP" },
			{ name: "托福 iBT 95", institution: "ETS" },
			{ name: "剑桥 B2 First (FCE)", institution: "Cambridge English" },
			{ name: "CEFR 英语 C1", institution: "Common European Framework" },
			{ name: "JLPT N4 合格", institution: "日本国际教育支援协会 / 国际交流基金" },
			{ name: "JLPT N3（备考中）", institution: "日本国际教育支援协会 / 国际交流基金" },
			{ name: "HSK 四级", institution: "中国国家汉办 / 汉考国际" },
			{ name: "HSKK 中级", institution: "汉考国际" },
			{ name: "TOPIK I 二级", institution: "NIIED / 世宗学堂" },
			{ name: "DELF B1", institution: "France Éducation International" },
			{ name: "歌德证书 B1", institution: "Goethe-Institut" },
			{ name: "DELE B1", institution: "Instituto Cervantes" },
			{ name: "CU-TEP 75", institution: "朱拉隆功大学" },
		],
		workshops: [
			{
				name: "现代 Web 基础设施研讨会",
